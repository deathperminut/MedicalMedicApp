...
export default function Carusel({data,props}) {
  ...
  return (
    <Animated.ScrollView onScroll={onScroll} scrollEventThrottle={16} decelerationRate={'fast'} snapToInterval={size} horizontal showsHorizontalScrollIndicator={false} bounces={false}  style={{width:'100%',maxHeight:190}}>
